  ...
  return (
    ...
    >
      ...
      <div className="hero-scroll-rotate relative z-10 max-w-[1600px] w-full flex flex-col lg:flex-row gap-12 origin-center mx-auto items-center">
        ...
        {/* Right Side: Photo */}
        <div className="w-full lg:w-2/5 flex justify-center lg:justify-start fade-in-element relative z-20 lg:-ml-16 lg:-mt-24">
          <div className="border-4 border-black p-4 shadow-brutal-lg rotate-[3deg] hover:rotate-0 hover:translate-y-[-4px] transition-all duration-300 w-full max-w-[420px] lg:max-w-[650px] brutal-color-cycle">
